...
export const popsBranches = pgTable(
  "pops_branches",
  {
  ...
  (t) => [uniqueIndex("pops_branches_org_code_uidx").on(t.organizationId, t.code)],
);
...
export const popsKitchenTickets = pgTable(
  ...
  (t) => [index("pops_kitchen_tickets_branch_status_idx").on(t.branchId, t.status)],
);
