...
CREATE UNIQUE INDEX "tax_authority_invoices_source_uidx" ON "tax_authority_invoices" USING btree ("organization_id","authority","source_type","source_id");--> statement-breakpoint
