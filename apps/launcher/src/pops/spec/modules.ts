...
export const popsNavItems: PopsNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "hr/staff-food", label: "Staff food" },
  ...
  { type: "link", path: "sync", label: "Sync & backup" },
  {
    ...
    children: [
      ...
      { path: "reports/kitchen-sale", label: "Kitchen Sale Report" },
      ...
      { path: "reports/day-book", label: "Day Book Report" },
      { path: "reports/in-out", label: "In-Out Report" },
      { path: "reports/kitchen-wise-purchase", label: "Kitchen wise purchase" },
      { path: "reports/sale-purchase-by-party", label: "Sale Purchase By Party" },
      { path: "reports/party-report", label: "Party Report" },
      { path: "reports/universal-ledger", label: "Universal Ledger" },
